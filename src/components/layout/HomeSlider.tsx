      ...
      <div data-hs-carousel='{"loadingClasses": "opacity-0", "isAutoPlay": true}' className="relative h-[850px] z-0">
        <div className="hs-carousel relative overflow-hidden w-full h-full">
          <div className="hs-carousel-body w-full absolute top-0 bottom-0 start-0 flex flex-nowrap duration-700 ease-in-out delay-200 opacity-0">
            ...
            {/*First Slide*/}
            <SlideBackground bgImage={'https://images.pexels.com/photos/12421015/pexels-photo-12421015.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1'}>
            ...
            {/*Second Slide*/}
            <SlideBackground bgImage={'https://images.pexels.com/photos/5379638/pexels-photo-5379638.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1'}>
            ...
            {/*Third Slide*/}
            <SlideBackground bgImage={'https://images.pexels.com/photos/12944630/pexels-photo-12944630.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1'}>
              <div className="w-full flex flex-row gap-6 justify-center items-center h-full absolute z-10">
